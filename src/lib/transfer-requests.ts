...
const transferSelect =
  "id,request_code,user_id,rent_console_id,developer_account_id,transaction_id,app_names,package_names,whatsapp_number,status,app_status,admin_note,created_at,updated_at,rent_consoles(id,name,console_type,console_url,live_price,weekly_price,transfer_apps_price,show_price_cents),user_profiles(email,display_name,whatsapp_number,is_trusted,is_blocked)";
